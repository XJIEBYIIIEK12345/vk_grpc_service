...
Для проверки тестирования необходимо при запущенном приложении (инструкция выше) открыть отдельную консоль, перейти к корневой директории проекта, а затем ввести команду (cmd):
